...
import womenAccessoriesData from "../womenData/womenAccessories";

const WomenAccessoriesPage = () => {
  return (
    <>
      <Navbar />
      <div className="min-h-screen p-8 mt-8">
        <h1 className="text-3xl font-bold mb-8 text-center">Women's Outwear</h1>
        {Object.keys(womenAccessoriesData).map((section, index) => (
          <div key={index} className="mb-12">
            ...
            <div className="grid gap-3 grid-cols-4">
              {womenAccessoriesData[section].map((product, idx) => (
                <ProductCard
                  key={idx}
                  image={product.image}
